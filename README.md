...
**Code Clarity Suggester** \(CCS\) aims to educate computing students about code clarity in programming. It scans Java/Python program code and highlights any identifier names or comments whose clarity needs to be improved. For convenience, the suggestion is mapped to an interactive HTML file as shown below. Further details can be found in [the paper](https://doi.org/10.1109/FIE49875.2021.9637193) published in 2021 IEEE Frontiers in Education (FIE) Conference. This is a work-in-progress and its final version can be seen [here](https://github.com/oscarkarnalim/CQS/)
